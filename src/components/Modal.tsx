  ...
  return (
    (<dialog id="action_details" className="modal prose">
      <div className="modal-box">
        ...
        <CallActionWalkthrough selectedAction={selectedAction} selectedActionOption={selectedActionOption} />
...
function CallActionWalkthrough({ selectedActionOption, selectedAction }: { selectedActionOption: string, selectedAction: any }) {
